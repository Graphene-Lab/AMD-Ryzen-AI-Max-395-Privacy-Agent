---
name: AMD Ryzen AI Max+ 395 Privacy Agent
description: Private, self-hosted AI office assistant for machines powered by the AMD Ryzen AI Max+ 395 processor (16-core x86, Windows and Linux) — local documents, office files, email, Telegram, voice and podcasts, fully offline with a local model.
keywords: [amd, ryzen ai, ryzen ai max 395, amd ryzen ai max+ 395, x86, windows, linux, npu, local ai, privacy, self-hosted, ai agent, office automation, voice assistant, telegram bot]
...
[![Install on Windows](https://img.shields.io/badge/Install%20on%20Windows-PowerShell-0078D6?style=for-the-badge&logo=windows&logoColor=white)](https://graphenelab.it/AgentBridge/install.ps1)
[![Install on Linux](https://img.shields.io/badge/Install%20on%20Linux-one%20command-FCC624?style=for-the-badge&logo=linux&logoColor=black)](https://graphenelab.it/AgentBridge/install.sh)
...
![Platform](https://img.shields.io/badge/Platform-Windows%20%2F%20Linux%20x64-orange)
...
[![AMD Ryzen AI Max+ 395 Privacy Agent terminal chat demo](media/demo.gif)](media/demo.mp4 "Watch the video")
